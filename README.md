...
- **[Typo tolerance](https://docs.meilisearch.com/learn/getting_started/customizing_relevancy.html#typo-tolerance):** Meilisearch adapts to typos and misspellings so your search results are always relevant
- **[Filtering and faceted search](https://docs.meilisearch.com/learn/advanced/filtering_and_faceted_search.html#configuring-filters):** enhance your user's search experience with custom filters and build a faceted search interface in a few lines of code
...
- **[Extensive language support](https://docs.meilisearch.com/learn/what_is_meilisearch/language.html):** Meilisearch works with all languages and offers optimized support for languages using the Latin alphabet, Chinese, Japanese, and Hebrew
...
- **Highly Customizable:** Meilisearch's default presets work out-of-the-box but are customizable to your specific needs
- **[RESTful API](https://docs.meilisearch.com/reference/api/overview.html):** seamlessly integrate Meilisearch in your technical stack with our plugins and SDKs
...
To request deletion of any already collected data, please write to us at [privacy@meilisearch.com](mailto:privacy@meilisearch.com). Don't forget to include your `Instance UID` in the message, as this helps us to quickly find and delete your data.
...
💌 Want to make a suggestion or give us feedback? Here are some of the channels where you can reach us:
